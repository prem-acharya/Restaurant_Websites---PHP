...
<body>
    ...
    <div class="container">
        ...
        <br />
        <br />
        <h3 align="center">Food order</h3><br />
        <h4 align="center"><a href="welcome.php">Home</a></h4>
        <br /><br />
        <?php
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="food.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span
    ...
    <!-- <?php //`$_POST['item_name'] =  ?> -->
    <h3><a class="a" href="./paycash/pay.php"><button>Payment</button></a></h3>
    <br>
    </div>
    <br />
